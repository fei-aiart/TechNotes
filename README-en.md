...
- [GAMES003: Essential Skills for Research](https://pengsida.net/games003/)
  - [Learning Research By Sida Peng](https://pengsida.net/games003/)
- For journal/conference selection, refer to:
  - CCF recommended lists: [International Journals/Conferences](中国计算机学会推荐国际学术会议和期刊目录-2022更名版.pdf), [Domestic Journals](计算领域高质量科技期刊分级目录.pdf)
  - CAAI recommended lists: [PDF](中国人工智能学会推荐国际学术会议、国际国内期刊目录（完整版）.pdf), [Official Website](https://www.caai.cn/index.php?s=/home/article/detail/id/4024.html)
  - International conference submission deadlines: [https://ccfddl.github.io/](https://ccfddl.github.io/)
- Detailed [Paper-Writing-Tips](https://github.com/MLNLP-World/Paper-Writing-Tips)
...
> This! This! This! --> 《[How to Write a Paper_WNN](如何写论文_WNN.pdf)》
...
- It is recommended to refer to 《[A not so short introduction to LATEX2ε](lshort-zh-cn.pdf)》 ([source@github](https://github.com/CTeX-org/lshort-zh-cn))
...
- Reference cases: [examples-visual-plots](exemples-visual-plots/)（`folder ↑`） · [**DINOv3**](https://arxiv.org/pdf/2508.10104) · [Vim@ICML](https://github.com/hustvl/Vim) · [Mamba-survey](https://arxiv.org/abs/2408.01129) · [MAGE@CVPR](https://github.com/LTH14/mage) · [SparK@ICLR](https://github.com/keyu-tian/SparK) · [InternVL](https://internvl.github.io/)
...
> - Recommended reading: 《[The Elements of Style](EoS_4thEd.pdf)》
...
----------
[Some suggestions for Word](TechNotesWord.md)

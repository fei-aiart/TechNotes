...
**深度协同·敏捷协作**：从项目第一天就紧密协作，频繁沟通，而不是等到最后“交作业”。
> - ！不要等自己完全写完，再发给导师或合作者。这样通常没有充足的打磨的时间。
> - 很早就开始写作：把导师和合作者拉到一个项目里（如overleaf），让大家随时看到进度、提出建议等。
> - （要主动：不要因为`觉得`他们“没用”就不找他们；加不加他们是你的事情，给不给反馈是他们的事情。）
> - 写和整理的过程，能够帮助发现不足、优化动机、补充实验分析等，使论文更完备。
